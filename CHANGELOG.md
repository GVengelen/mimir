...
* [ENHANCEMENT] Query-scheduler: Introduce `prioritizeQueryComponents`, which allows configuration of the query-scheduler tree to prioritize dequeueing from a specific query component more highly than dequeueing from a specific tenant. #7873
